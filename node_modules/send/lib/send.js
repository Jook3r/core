...
SendStream.prototype.removeContentHeaderFields = function(){
  var res = this.res;
  Object.keys(res.getHeaders ? res.getHeaders() : (res._headers || {})).forEach(function(field){
...
SendStream.prototype.isFresh = function(){
  return fresh(this.req.headers, this.res.getHeaders ? this.res.getHeaders() : (this.res._headers || {}));
};
